...
$(document).ready(function() {
 ...
 $('#delete_conf_article').click(function(){
	 ...
	 $.ajax({              
         ...
         url: "<?php echo base_url(); ?>index.php/admin/activearticles/delete_entrie",
         success: function(data){
       	   if(data.answer == true)
       	   {
       		window.location.href ="<?php echo base_url() ?>index.php/admin/activearticles";
           }            	                 
         }
     }); 	 
...
if ($task != 'delete')
{
	...
	{			
		...
		$title_2=$entrie_data->title_2;
		$introtext=$entrie_data->introtext;
		$content=$entrie_data->content;
		$author= $entrie_data->author;
		$date= $entrie_data->date;
		$journal_reference= $entrie_data->journal_reference ;
		$id_article=$entrie_data->id_active_article;		
		$entrie_data->active == 'checked="checked"'  ? $checked_actived =  TRUE : $checked_actived = FALSE ;
	...
	echo form_label('Titre 2', 'title_2', $attributes).'<br />';
	...
	$introtext ? $fulltext = $introtext .'<hr />'.$content : $fulltext = $content ;
	...
	$data = array(
	 ...
	 echo form_input($data).'<br />';
	  ...
	  echo form_label('Activer', 'active', $attributes).'<br />';
	 
	 $data = array(
	    'name'        => 'active',
	    'id'          => 'active',
	    'value'       => '1',
	    'checked'     => $checked_actived,
	    'style'       => 'margin:10px',
	    );
