...
class Articles extends CI_Controller {
	   ...
	   public function __construct ()
	   {
		...
		function get_article_form()
		{
			...
			$this->input->post('id_article') != 0 ? $data['entrie_data']= $this->Mdl_admin_article->get_entrie($this->input->post('id_article')) : $data['entrie_data']= '';
	     ...
	     /*public function listener ()
		   ...
		   public function getFrom()
			...
			{	
			$this->Mdl_admin_article->create_entrie() ;	
			}
			
			public function delete_entrie ()
			{
			 $this->Mdl_admin_article->delete_entrie() ;	
			}
			
			public function dafault_article () {		
				$this->Mdl_admin_article->dafault_journal();
